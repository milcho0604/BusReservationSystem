package com.example.bussystem.common.config;

import com.example.bussystem.common.auth.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .httpBasic().disable()
                .authorizeRequests()
                    .antMatchers("/","/user/create", "/user/doLogin", "/user/refresh-token,","/bus/list" )
                    .permitAll()
